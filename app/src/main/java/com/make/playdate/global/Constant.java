package com.make.playdate.global;
...
public interface Constant {
    String BASE_URL = "https://makeplaydate.info/playdate/public/api/";

    String MYREF = "user_id";
    ...
    String[] genderArray = {"female", "male", "non-binary"};
